...
class BillCard extends StatelessWidget {
  ...
  ({Color background, Color text, Color accent}) _getDerivedColors(
    Color baseColor,
    bool isDark,
  ) {
  ...
  Widget build(BuildContext context) {
    ...
    switch (_paymentStatus) {
      case PaymentStatus.fullPaid:
        baseColor = fullyPaidColor ?? colorScheme.secondary;
        break;
      case PaymentStatus.partiallyPaid:
        baseColor = partiallyPaidColor ?? Colors.amber;
        break;
      case PaymentStatus.unpaid:
        baseColor = unpaidColor ?? colorScheme.error;
        break;
    }

    final derivedColors = _getDerivedColors(baseColor, isDark);
