...
class _HoverScaleContainerState extends State<HoverScaleContainer> {
  ...
  Widget build(BuildContext context) {
    final baseHeight = widget.height * 0.92;
    final expandedHeight = baseHeight + 180; // Adjust based on content height
    ...
    return MouseRegion(
      ...
      child: Center(
        child: AnimatedContainer(
          ...
          width: widget.width * 0.92, // Width remains constant
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          customChip(
                            ...
                            chipColor: Colors.red[600]!,
                            backgroundColor: Colors.red[100]!,
                            chipTitle: "X-RAY ${widget.doctor.xrayPercentage}",
                          ),
                        ],
                      ),
                      const SizedBox(height: 8),
