...
String singleSampleReportEndpoint(int id) => "$sampleReportsEndpoint$id/";
...
final singleSampleReportProvider = FutureProvider.autoDispose
    .family<SampleReportModel, int>((ref, id) async {
...
final createSampleReportProvider = FutureProvider.autoDispose
    .family<SampleReportModel, SampleReportModel>((ref, newReport) async {
...
final updateSampleReportProvider = FutureProvider.autoDispose
    .family<SampleReportModel, SampleReportModel>((ref, updatedReport) async {
